window.onload = () => {
    ...
    let enemies = [];
    var dur = 200;
    var ok = confirm(" если ты используешь сенсорный экран то в эту игру играть можно?")
    if(ok != true){
        dur = 100;
    }
    alert(Инструкция для игры:
    нихуя не делай просто играй)
    var posX = 50;
...
document.getElementById("sco").innerHTML = "Счёт : "+ score ;
...
/***             *****/
 ...
 if(alive == true){
     score+=1;
        ...
        score+=0;
    } document.getElementById("p").innerHTML = "Счёт : "+score;
 }
